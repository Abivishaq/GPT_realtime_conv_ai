...
def detect_speech(threshold):
    ...
    if energy > threshold:
        print('Speech detected. Energy: ', energy)
    else:
        print('No speech detected. Energy: ', energy)
    return energy > threshold

def play_audio_with_detection(file_path, noise_level, sensitivity=1.0):
    """
...
if __name__ == "__main__":
    ...
    time.sleep(2)
    ambient_noise_level = 1000 #calibrate_noise_level()
