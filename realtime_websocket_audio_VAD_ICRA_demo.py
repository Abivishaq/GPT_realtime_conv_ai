...
from ai_ratio_plotter import AIRatioPlotter
from ai_ratio_plotter_web import AIRatioPlotterWeb
import threading
...
class RealtimeAssistant:
    ...
    def update_instructions(self, instructions):
        ...
        print("Updating instructions to :", instructions)
        event = {
            "type": "session.update",
            "session": {
...
if __name__ == "__main__":
    ...
    plotter = AIRatioPlotter(assistant.interaction_analyzer, background_img_path="red_green_split.png")
    plotter_web = AIRatioPlotterWeb(assistant.interaction_analyzer, background_img_path="red_green_split.png", port=5001)
